...
public class ApiService {
    ...
    // New method for mock script generation
    public ResponseEntity<Map<String, Object>> generateMockScripts(String apiId) {
        String apiUrl = "https://api.kriate.co.in:8344/api/am/publisher/v4/apis/" + apiId + "/generate-mock-scripts";

        // Get or refresh token
        token = fetchNewToken();
        System.out.println("generateMockScripts token: " + token);
